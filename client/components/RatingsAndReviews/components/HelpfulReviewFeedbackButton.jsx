...
const HelpfulReviewFeedbackButton = ({ review_id, helpfulnessRating, LogClick }) => {
    ...
    return (
      <div className="IndividualReviewTile-helpful-button">Was this review helpful?&nbsp;
        {isHelpfulReviewFeedbackButtonClicked 
        ? (
          <div>
            <button type="button" style={{color: "#a6a6a6"}}>Yes</button>{helpfulnessRating + 1}
