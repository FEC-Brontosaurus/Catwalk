...
const SpecifiedCharacteristicsAddReviewModal = ({ characteristicsMetadataObj, currentProduct_id, LogClick }) => {
  ...
  return (
    <div>
      <button type="button" className="RatingAndReviews-bottom-buttons" id="myBtn" onClick={() => { openReviewModal(reviewModalRef), LogClick('button', 'RatingsAndReviews') }}>Add Review</button>
      <div ref={reviewModalRef} id="myModal" className="modal">
        <div className="modal-content">
          ...
          {Object.keys(characteristicsMetadataObj).map((characteristicName) => {
            return (
              <div className="add-review-characteristics" key={`${characteristicName}-fragment`}>
